...
- New internal path:
  - [`../../.agents/internal-docs/wave1/phase-ledger-candidate.md`](../../../.agents/internal-docs/wave1/phase-ledger-candidate.md)
- Why it moved:
  - this file is a staging ledger candidate for later absorption, not a public
    product, proof, distribution, or API front-door page
