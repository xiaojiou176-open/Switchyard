...
- New internal path:
  - [`../../.agents/internal-docs/wave1/runtime-closeout-rerun.md`](../../../.agents/internal-docs/wave1/runtime-closeout-rerun.md)
- Why it moved:
  - this file is a rerun ledger and blocker-analysis pack for internal closeout,
    not a public product, proof, distribution, or API front-door page
