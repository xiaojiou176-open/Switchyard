...
const openrouterByokProvider = createDescriptorProvider({
    ...
    transport: {
        ...
        sdkBinding: {
            ...
            modelInvocation: "createOpenAICompatible({ name: 'openrouter', baseURL: 'https://openrouter.ai/api/v1', apiKey: process.env.OPENROUTER_API_KEY }).chatModel('openai/gpt-4.1-mini')",
        },
    },
});
