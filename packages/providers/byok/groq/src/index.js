...
const groqByokProvider = createDescriptorProvider({
    ...
    transport: {
        ...
        sdkBinding: {
            ...
            modelInvocation: "createOpenAICompatible({ name: 'groq', baseURL: 'https://api.groq.com/openai/v1', apiKey: process.env.GROQ_API_KEY }).chatModel('llama-3.3-70b-versatile')",
        },
    },
});
