...
const qwenByokProvider = createDescriptorProvider({
    ...
    transport: {
        ...
        sdkBinding: {
            ...
            modelInvocation: "createOpenAICompatible({ name: 'qwen', baseURL: 'https://dashscope.aliyuncs.com/compatible-mode/v1', apiKey: process.env.QWEN_API_KEY ?? process.env.DASHSCOPE_API_KEY }).chatModel('qwen-plus')",
        },
    },
});
