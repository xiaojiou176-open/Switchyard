...
describe("Switchyard docs frontdoor contracts", () => {
  ...
  it("keeps blocker count and default service port aligned across frontdoor docs", () => {
    const readme = read("README.md");
    const m2Verdict = read("docs/blueprints/m2-kernel-beta-verdict.md");
    const m3Readiness = read("docs/blueprints/m3-first-party-integration-readiness.md");
  ...
  it("keeps a machine-readable outward catalog linked from frontdoor docs", () => {
    ...
    expect(compatReadme).toContain("docs/public-surface-catalog.json");
    expect(compatReadme).toContain("docs/public-surface-catalog.schema.json");
    expect(compatReadme).toContain("docs/plugin-skill-starter-kits.md");
    expect(compatReadme).toContain("docs/starter-manifest-templates.md");
    expect(compatReadme).toContain("docs/starter-manifest-templates.schema.json");
    expect(compatReadme).toContain("docs/starter-manifest-examples.md");
    expect(compatReadme).toContain("docs/starter-manifest-examples.schema.json");
    expect(compatReadme).toContain("docs/provider-runtime-catalog.md");
    expect(compatReadme).toContain("docs/compat-target-catalog.md");
    expect(compatReadme).toContain("docs/compat-target-catalog.json");
    expect(compatReadme).toContain("docs/compat-target-catalog.schema.json");
    expect(compatReadme).toContain("docs/builder-kit-catalog.md");
    expect(compatReadme).toContain("docs/builder-kit-catalog.json");
    expect(compatReadme).toContain("docs/builder-kit-catalog.schema.json");
    expect(compatReadme).toContain("docs/skill-pack-catalog.md");
    expect(compatReadme).toContain("docs/skill-pack-catalog.json");
    expect(compatReadme).toContain("docs/skill-pack-catalog.schema.json");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- provider-catalog-schema");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- surface-catalog-schema");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- compat-target-catalog");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- compat-target-catalog-schema");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- builder-kit-catalog");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- builder-kit-catalog-schema");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- compat-targets");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- builder-kits");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- skill-pack-catalog");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- skill-pack-catalog-schema");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- provider-catalog");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- starter-manifests");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- starter-manifests-schema");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- starter-examples");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- starter-examples-schema");
    expect(compatReadme).toContain("docs/starter-pack-index.md");
    expect(compatReadme).toContain("docs/starter-pack-chooser.md");
    expect(compatReadme).toContain("docs/starter-pack-comparison.md");
    expect(compatReadme).toContain("docs/host-integration-playbooks.md");
    expect(compatReadme).toContain("docs/host-integration-examples.md");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- host-examples");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- host-examples-schema");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- host-example --target codex");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- starter-pack-chooser");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- starter-pack-scenario --target codex-builder");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- starter-pack-comparison");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- starter-pack-filter --target read-only-truth");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- host-playbooks");
    expect(compatReadme).toContain("pnpm run switchyard:cli -- host-playbook --target codex");
