...
It remains useful when the question is:

> Which MCP listing lane is blocked by repo truth, which one is owner-manual,
> and which packet is only packet-ready rather than listed-live?

## Why It Moved

- this file is an outer-lane listing cockpit and packet/accounting workbench
- it is not a public product, proof, distribution, or API front-door page
- public readers should not open host-review receipts, owner-submit tables, or
  marketplace intake packets as their first explanation of Switchyard
